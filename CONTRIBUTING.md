...
- **Tilføje en case** – en konkret erfaring eller situation fra en af SDLC-faserne.  
  Brug gerne [case-skabelonen](docs/case-skabelon.md) som udgangspunkt.

- **Udvikle en mini-guide** – en kort og handlingsorienteret vejledning til et specifikt emne (fx “Threat Modeling for små teams”).

- **Dele refleksioner** – via *Discussions*-fanen på GitHub, hvor erfaringer og dilemmaer fra praksis kan drøftes.
...
### Typisk review-forløb

1. **Tjek for form og struktur**  
